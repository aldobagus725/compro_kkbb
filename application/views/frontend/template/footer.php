...
<!-- FOOTER --> 
<br>
<footer class="bg-dark footer-uhuy" style="color:white;">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-sm-5">
                        ...
                        <!-- <p>
                            Pendeta Jemaat <br>GPIB Kasih Karunia Badung-Bali <br>
                            <b>[Pdt. Ny. Wilhelmina Johansz]</b>
                        </p> -->
                    </div>
                    <div class="col-sm-4">
                        <ul>
                            <!-- <li><a class="about-us" href="#" target="_blank"><i class="fab fa-facebook-f"></i>&nbsp;Facebook</a></li>
                            <li><a class="about-us" href="#" target="_blank"><i class="fab fa-instagram"></i>&nbsp;Instagram</a></li> -->
                            <li><a class="about-us" href="#">Pelayanan Pernikahan</a></li>
                            <li><a class="about-us" href="#">Pelayanan Baptisan</a></li>
                            <li><a class="about-us" href="#">Informasi Katekisasi</a></li>
                            <li><a class="about-us" href="#">Daftar Jemaat Baru</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-3">
                        <ul style="list-style-type:none;">
                            <!-- <li><a class="about-us" href="#" target="_blank"><i class="fab fa-facebook-f"></i>&nbsp;Facebook</a></li>
                            <li><a class="about-us" href="#" target="_blank"><i class="fab fa-instagram"></i>&nbsp;Instagram</a></li> -->
                            <li><a class="about-us" target="_blank" href="https://wa.me/6282247231915?text=Halo%20saya%20ingin%20mencari%20informasi" target="_blank"><i class='fab fa-whatsapp'></i>&nbsp;Whatsapp</a></li>
                            <li><a class="about-us" target="_blank" href="#">Blog Gereja</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
                <h1 class="footer-title">Alamat Gereja</h1>
                <hr>
                <h6>Google Map Gereja GPIB Kasih Karunia Badung - Bali:</h6>
            ...
            <div class="col-sm-3">
            <h1 class="footer-title">Alamat Kantor Gereja</h1>
                <hr>
                <h6>Google Map Kantor GPIB Kasih Karunia Badung - Bali:</h6>
        ...
        <div class="row">
            <div class="col mx-auto text-end">
                 &copy; 2021 Copyright KOMISI INFORKOM GPIB KASIH KARUNIA BADUNG - BALI <i>(still in development)</i>
            </div>
        </div>
    </div>
</footer>
