...
<div class="container">
    <div class="row align-items-center">
        <div class="col-sm-4">
            <h1 class="display-5 fw-bold">Welcome Home!</h1>
            <p class="lead mb-5">GPIB Jemaat "Kasih Karunia" Badung-Bali</p>
        </div>
        <div class="col">
            <img class="d-block mx-auto mb-4" src="<?=base_url('assets/img/heroes.png')?>" alt="gpib" width="100%">
        </div>
    </div>
</div>
<!-- Salam -->
        ...
        <div class="col">
            <div class="card rounded-0">
                <div class="card-header rounded-0 bg-success text-white">
                    <h5>Ibadah Minggu (Offline & Online)</h5>
                </div>
...
<div class="container">
    <div class="row">
        <div class="col-sm-6">
            <div class="card rounded-0">
                <div class="card-header rounded-0 bg-success text-white">
                    <h5>Ibadah Keluarga (Zoom Meetings)</h5>
                </div>
                <div class="card-body rounded-0">
                    <div class="row">
                        <div class="col-sm-4">
                            <img src="<?=base_url('assets/img/gpib_new.png')?>" class="card-img-top" alt="ika">
                        </div>
                        <div class="col-sm-8">
                            <h5 class="card-title">Ibadah Keluarga Daring</h5>
                            <p class="card-text">Setiap Rabu <br> Pukul 19.00</p>
                            <a class="btn btn-primary btn-lg" target="_blank" href="https://us02web.zoom.us/j/83227041010?pwd=UXNYTDJMRGt2WkY3ZWpVak5YUU9zUT09">Ikuti</a>
                        </div>
                    </div>
                </div>
            </div>
