		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a href="<?= current_url() ?>">Edit Komisi</a></li>
				</ol>
			</div>
		</div>
	</div>
			...
			<div class="col-md-12">
				<div class="card">
                    ...
                    <?php if ($komisi){
                        foreach ($komisi as $p){
                    ?>
                    <form class="submitEditKomisi" action="<?= base_url('admin/komisi/update/'.$p->id) ?>" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="form-group">
                                <label>Area Komisi</label>
                                <input type="text" required class="form-control komisi" value="<?=$p->komisi?>" name="komisi" id="komisi" placeholder="eg. Anthiokia">
                            </div>
                            <div class="form-group">
                                <label>Judul Post Komisi</label>
                                <input type="text" required class="form-control title" value="<?=$p->title?>" name="title" id="title" placeholder="Judul, e.g. Daftar Komisi Anthiokia">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col">
                                    <i>*current image</i>
                                    <br>
                                    <img src="<?=base_url('resource/komisi/'.$p->image)?>" style="width:75%;">
                                </div>
                            </div>
                        </div>
                    ...
                    <?php } } else { ?>
                        <div class="alert alert-warning text-center" role="alert">
                            ...
                            <a href="<?= base_url('admin/komisi') ?>">GO BACK</a>
                        </div>
                    <?php } ?>
				</div>
			</div>
