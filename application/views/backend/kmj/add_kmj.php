		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a href="<?= current_url() ?>">Tambah KMJ</a></li>
				</ol>
			</div>
		</div>
	</div>
					...
					<div class="card-header bg-dark">
						<div class="row align-items-center">
							<div class="col">
								...
								<h3 class="card-title">Tambah KMJ </h3>
							</div>
						</div>
					</div>
                    <form class="submitAddKmj" action="<?= base_url('admin/kmj/set') ?>" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="form-group">
                                <label>Nama Lengkap KMJ</label>
                                <input type="text" required class="form-control nama_lengkap" name="nama_lengkap" id="nama_lengkap">
                            </div>
                            <div class="form-group">
                                <label>Periode Jabatan</label>
                                <input type="text" required class="form-control periode" name="periode" id="periode">
                            </div>
                            <div class="form-group">
                                <label>FOTO KMJ <span style="color: red;">*</span></label>
